...
namespace NaturalPoint.NatNetLib
{
    ...
    [StructLayout( LayoutKind.Sequential, CharSet = CharSet.Ansi )]
    internal struct NatNet_Client_Connect_Params
    {
    ...
    internal static class NativeMethods
    {
        ...
        [DllImport( NatNetConstants.NatNetLibDllBaseName, CallingConvention = NatNetConstants.NatNetLibCallingConvention )]
        public static extern NatNetError NatNet_Client_Connect( IntPtr clientHandle, ref NatNet_Client_Connect_Params connectParams );
