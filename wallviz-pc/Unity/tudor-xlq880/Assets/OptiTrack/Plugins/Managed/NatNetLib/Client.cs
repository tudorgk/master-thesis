...
namespace NaturalPoint.NatNetLib
{
    ...
    internal class NatNetClient : IDisposable
    {
        ...
        public void Connect( IPAddress localAddress, IPAddress serverAddress,
                             UInt16 serverCommandPort = 0, UInt16 serverDataPort = 0,
                             IPAddress multicastAddress = null )
        {
            ThrowIfDisposed();

            NatNet_Client_Connect_Params initParams = new NatNet_Client_Connect_Params {
