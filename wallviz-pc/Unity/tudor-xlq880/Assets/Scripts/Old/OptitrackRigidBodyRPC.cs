...
public class OptitrackRigidBodyRPC : MonoBehaviour
{
    public OptitrackStreamingClient StreamingClient;
    public Int32 RigidBodyId = 1;
    
    [HideInInspector]
    public GameObject remoteSmartwatch;
    ...
    void Update()
    {
        ...
        if ( rbState != null && remoteSmartwatch !=null )
        {
            remoteSmartwatch.transform.localPosition = vector3Filter.Filter(rbState.Pose.Position);
            remoteSmartwatch.transform.localRotation = quaternionFilter.Filter(rbState.Pose.Orientation);
        }
    }
}
